        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <div class="typewriter">Full-Stack Engineer • CI/CD Pipelines • AWS Cloud • AI Automation</div>
                    <p class="hero-subtitle mt-3">10+ years engineering scalable web platforms — from pixel-perfect frontends to cloud-native backends on AWS (EC2, S3, Lambda). Builds and owns end-to-end CI/CD pipelines with GitHub Actions, manages Linux servers, writes shell scripts to automate deployments, and integrates AI workflows using n8n, OpenAI, and Claude. Leads cross-functional teams and ships measurable outcomes at enterprise scale.</p>
                    ...
                    <div class="mt-4">
                        <ul class="list-unstyled row hightlights">
                            <li class="col-sm-6"><i class="fas fa-laptop-code"></i> Full-stack engineering (MERN & LAMP)</li>
                            ...
                            <li class="col-sm-6"><i class="fas fa-robot"></i> AI automation: n8n, OpenAI, Claude Code</li>
                ...
                <div class="col-md-8">
                    ...
                    <section id="work-history">
                        ...
                        <article class="pb-5">
                            ...
                            <ul>
                                <li>Architected and shipped scalable full-stack applications using the MERN stack (MongoDB, Express.js, React.js, Node.js) and LAMP stack, serving 6,000+ active users with high availability.</li>
                                <li>Designed and maintained end-to-end <strong>CI/CD pipelines using GitHub Actions</strong> — automating build, test, and deployment workflows to staging and production environments with zero-downtime releases.</li>
                                <li>Provisioned and managed <strong>AWS infrastructure</strong>: EC2 instances for application hosting, S3 buckets for asset storage and static delivery, and Lambda functions for serverless event-driven processing.</li>
                                <li>Administered <strong>Linux servers</strong> (Ubuntu/CentOS), writing <strong>shell scripts</strong> to automate server provisioning, log rotation, cron-based jobs, and deployment tasks — reducing manual ops overhead significantly.</li>
                                <li>Built AI-powered automation pipelines using <strong>n8n</strong>, <strong>OpenAI</strong>, and <strong>Claude</strong> — automating data enrichment, content generation, and social media publishing; cut manual effort by ~70%.</li>
                                <li>Integrated third-party APIs (DTCM, Eventsair) for registration data retrieval and barcode generation using PHP, cURL, REST, and GraphQL; maintained robust version control via Git/GitHub.</li>
                            </ul>
                        ...
                        <article class="pb-5">
                            ...
                            <ul>
                                <li>Led a team of developers end-to-end through the SDLC — from sprint planning to production release — delivering enterprise projects serving <strong>30,000+ users</strong> on time and within scope.</li>
                                <li>Engineered and owned <strong>CI/CD pipelines using GitHub Actions</strong> — automating build, lint, test, and deployment stages; integrated cron jobs and shell scripts for scheduled deployments and server-side automation.</li>
                                <li>Drove uptime from <strong>80% → 99.9%</strong> through performance hardening, redundancy implementation, and mitigating Brute-force and DDoS attacks on Linux-hosted infrastructure.</li>
                                <li>Built full-stack features using PHP, Node.js, React.js, MySQL, AJAX, and REST APIs; applied Figma designs to production with strict accessibility and cross-browser standards.</li>
                                <li>Leveraged Google Analytics, Clarity, and HubSpot data to drive engagement improvements — connecting engineering decisions directly to measurable business outcomes.</li>
                            </ul>
